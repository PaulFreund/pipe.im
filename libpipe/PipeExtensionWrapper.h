...
class PipeExtensionWrapper {
public:
	PipeExtensionWrapper(PipeExtensionFunctions functions) : _functions(functions) {

	}

	~PipeExtensionWrapper() {

	}

	vector<tstring> getServiceProviders() {
		return { "one", "two" }; // TODO: Debug
	}
